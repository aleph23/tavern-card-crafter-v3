...
export const hoverEffects = cva('transition-all duration-300', {
  variants: {
    hover: {
      none: '',
      glow: 'shadow-lg shadow-secondary/50 hover:shadow-xl hover:shadow-secondary/70',
      shimmer:
        'relative overflow-hidden before:absolute before:inset-0 before:-translate-x-full before:bg-linear-to-r before:from-transparent before:via-white/20 before:to-transparent hover:before:translate-x-full before:transition-transform before:duration-1000',
      ripple:
