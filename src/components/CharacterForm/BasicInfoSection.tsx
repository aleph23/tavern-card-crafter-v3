...
const BasicInfoSection = ({
  ...
  const handleClearDescription = () => {
    ...
    toast({ title: 'Cleared', description: 'Character description has been cleared' })
  }
      ...
      <div className='form-group'>
        <div className='flex items-center justify-between mb-2'>
          ...
          <div className='flex gap-1'>
            ...
            <Button size='sm' variant='outline' onClick={handleClearDescription} className='h-8 px-2 text-xs'>
